...
// insert query
    $sql="INSERT INTO add_image(name,datetime,author,image)";
            ...
            <div class="col" id="categoryParent">
                <div class="card" id="categoryContainer">
                    <div class="card-header">
                        ...
                        <div class="container category-section bg-warning">
                            <form class="p-4" action="addimage.php"method="post"enctype="multipart/form-data">
                                <div class="form-group">
                                  <div class="container">
                                    <input type="text" name="name" placeholder="Unique Image Name"><br><br>
                                    <label for="image"class="font-weight-bold">Image and Medias</label>
                        ...
                        <div class="table-responsive">
                            ...
                            if (isset($_GET["SearchButton"])) {
                                ...
                                $sql = "SELECT * FROM add_image ORDER BY id desc LIMIT $ShowPostFrom,5";
                                $stmt = $ConnectingDb->query($sql);
                                                # code...
                            } else {
                                $sql = "SELECT * FROM add_image ORDER BY id desc LIMIT 0,10";
                                $stmt = $ConnectingDb->query($sql);
                            }
                                ...
                                <tbody class="text-center">
                                    <tr>
                                      ...
                                      <td>
                                        ...
                                        <img src="../uploads/docs/<?php echo $Image; ?>"width="100px;"alt="File deleted">
                                    </td>

                                    <td><a href="../uploads/docs/<?php echo $Image; ?>"target="blank"><?php
                                    echo  $Image; ?></a></td>

                                    <td><?php 
                                    echo $GivenName; ?></td>
                                    <td><a href="delete-link-image.php?date=<?php echo $DateTime?>"><?php 
                                    echo "delete image"; ?></a></td>
                ...
                <nav class="py-2">
                    <ul class="pagination pagination-md">
                        <?php
                        global $ConnectingDb;
                        $sql = "SELECT COUNT(*) FROM add_image";
                        $stmt = $ConnectingDb->query($sql);
                        ...
                        for ($i = 1; $i <= $PostPagination; $i++) {
                            if (!isset($_GET["Search"])) {
                                ...
                                if ($i == $Page) {
                                    ...
                                    ?>
                                    <li class="page-item">
                                        <a href="addimage.php?page=<?php echo $i ?>" class="page-link bg-primary"><?php echo $i ?></a>
                                    </li>
                                <?php } else {
                                                    # code...
                                    ?>
                                    <li class="page-item">
                                        <a href="addimage.php?page=<?php echo $i ?>" class="page-link bg-secondary"><?php echo $i ?></a>
                                        </li><?php } ?>
                                    <?php }
                                } ?>
                            </ul>
